...
const About = () => {
  ...
  <div className="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
    ...
    <div className="w-full md:w-2/3 flex flex-col mb-16 items-center text-center">
      ...
      <p className="mb-8 leading-relaxed">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa molestiae quod ut commodi iste sit blanditiis neque incidunt odit fugiat laboriosam temporibus, sequi eveniet dolores aliquid provident fugit rerum consequuntur unde saepe vero, cumque ipsam? Illo fuga cumque repellat ipsum animi laboriosam, ratione laborum quis nisi obcaecati nemo velit suscipit voluptatem dolore a totam inventore, libero perspiciatis rem aliquid ipsam? </p>
      ...
      <p className="text-sm mt-2 text-gray-500 mb-8 w-full"> Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
      <div className="flex">
